  ...
  return (
    <div className="">
      <Container className="mt-10 sm:mt-16 md:mt-32 pb-32 lg:pb-12 ">
        <footer className="flex flex-col gap-8 md:gap-16 mx-auto max-w-screen-lg">
          {/*
        <div className=" w-full px-4  h-56 sm:h-80 border rounded-3xl flex flex-col items-center justify-center bg-gradient-to-t from-zinc-200 via-zinc-100 dark:from-cyan-950/5 dark:via-transparent to-transparent">
