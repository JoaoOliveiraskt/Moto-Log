...
async function SearchResultsContent({ q, type }: { q: string; type?: string }) {
    ...
    return (
        <div className="space-y-8">
            {/* Lojas */}
            {stores.length > 0 && (!type || type === "stores") && (
                <section className="space-y-4">
                    {showTitles && <TypographyH4>Lojas</TypographyH4>}
            ...
            {/* Categorias */}
            {categories.length > 0 && (!type || type === "categories") && (
                <section className="space-y-4">
                    {showTitles && <TypographyH4>Categorias</TypographyH4>}
