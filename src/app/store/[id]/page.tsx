  ...
  return (
    <>
      ...
      <Container className="px-0">
        <div className="flex flex-col w-full mt-0 xl:mt-[68px]">
          ...
          <div className="bg-background px-4 md:px-6 lg:px-0">
              ...
              <div className="space-y-8">
               ...
               <div className="grid gap-1">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    Orgulhamo-nos de nossa ampla seleção das últimas tendências
                    e nosso excepcional atendimento ao cliente.
                  </p>
                </div>
                <div className="grid gap-1">
                  <h2 className="text-2xl font-bold text-foreground">
